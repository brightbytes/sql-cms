$(function(){
  $('#transform_runner').on('change', function(e){
    ...
    $('#transform_s3_region_name_input').toggle($(this).val() == 'CopyTo');
    $('#transform_s3_bucket_name_input').toggle($(this).val() == 'CopyTo');
    $('#transform_s3_file_path_input').toggle($(this).val() == 'CopyTo');
    $('#transform_s3_file_name_input').toggle($(this).val() == 'CopyTo');
