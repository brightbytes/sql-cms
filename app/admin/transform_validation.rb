ActiveAdmin.register TransformValidation do
  ...
  form do |f|
    ...
    inputs 'Details' do
      ...
      input :transform_params_yaml, as: :text, collection: [[resource.transform.params_yaml, resource.transform.id, selected: true]], input_html: { disabled: true }, hint: "These params will be reverse-merged into the params_yaml in the following field."
