...
module Logics
  module ValidationFactory
    ...
    def fk_integrity
      Validation.where(name: 'Field Value is an FK-Reference').first_or_create!(
        immutable: true,
    ...
    def inclusion
      Validation.where(name: 'Field Value is in Set of Values').first_or_create!(
        immutable: true,
    ...
    def integer_with_extras
      Validation.where(name: 'Field Value is an Integer or one of the extra values').first_or_create!(
        immutable: true,
